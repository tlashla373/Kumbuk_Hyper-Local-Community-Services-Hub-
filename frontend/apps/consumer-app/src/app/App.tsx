  ...
  return (
    <>
      ...
      >
        ...
        >
          <View style={styles.section}>
            ...
            <Text
              ...
              role="heading"
            >
              Welcome Kumbuk Consumer 👋
            </Text>

            {/* Quick entry to chat interface */}
            <TouchableOpacity
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={styles.codeBlock}>
                ...
                >
                  nx test Kumbuk Consumer
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Lint
                </Text>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx lint Kumbuk Consumer
                </Text>
                <Text style={[styles.textXS, styles.monospace, styles.comment]}>
                  # Run them together!
                </Text>
                ...
                >
                  nx run-many -p Kumbuk Consumer -t build test lint
                </Text>
              </View>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                <Text style={[styles.textXS, styles.monospace]}>
                  nx show project Kumbuk Consumer
                </Text>
              </View>
              <View style={styles.listItem}>
                <Svg
        ...
        {/* Render chat as full screen when requested */}
        {showChat && (
          <View style={styles.chatOverlay}>
            <View style={styles.chatHeader}>
              <TouchableOpacity onPress={() => setShowChat(false)}>
                <Text style={styles.chatHeaderBack}>{'< Back'}</Text>
              </TouchableOpacity>
              <Text style={styles.chatHeaderTitle}>KumbuK Chat</Text>
              <View style={{ width: 60 }} />
            </View>
            {/* ChatScreen will provide the AgentChat component */}
            <View style={{ flex: 1 }}>
              {/* Import is dynamic to avoid changing app routing; static import below */}
              {/* @ts-ignore */}
              {require('../screens/ChatScreen').default ? (
                // eslint-disable-next-line react/jsx-no-undef
                React.createElement(require('../screens/ChatScreen').default)
              ) : null}
            </View>
          </View>
        )}
